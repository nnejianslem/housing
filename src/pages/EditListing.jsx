  ...
  return (
    <main className="max-w-md px-2 mx-auto">
        ...
        <form onSubmit={onSubmit}>
            ...
            <button type="submit" className="mb-6 w-full px-7 py-3 bg-blue-600 text-white font-medium text-sm uppercase rounded shadow-md hover:bg-blue-900 hover:shadow-lg focus:bg-blue-400 focus:shadow-2xl active:bg-blue-100 active:shadow-lg transition duration-1000 ease-in-out ">Edit Listing</button>
        </form>
    </main>
  )
}
